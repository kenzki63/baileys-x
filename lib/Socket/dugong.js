...
class xeonDugong {
      ...
      album = await this.utils.generateWAMessageFromContent(jid, {
        ...
        albumMessage: {
          expectedImageCount: array.filter(a => {
            return a.hasOwnProperty("image");
          }).length,
          expectedVideoCount: array.filter(a => {
            return a.hasOwnProperty("video");
          }).length
        }
      }, {
        ...
        viewOnceMessage: {
          message: {
            ...
            eventMessage: {
              ...
              endTime: typeof eventData.endTime === "string" ? parseInt(eventData.endTime) : eventData.endTime || Date.now() + 0x36ee80,
  ...
  async handleGroupStory(content, jid, quoted) {
    ...
    let __p_DyNt_msg_message = {
      groupStatusMessageV2: {
        message: waMsgContent.message || waMsgContent
      }
    };
    return await this.relayMessage(jid, __p_DyNt_msg_message, {
